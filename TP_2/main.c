...
* Objetivo:
       ...
       ** Definir una estructura que represente una persona, con los campos:
            ...
            - DNI
            - Flag de estado
       ** Crear un programa que defina un array de 20 items de la estructura creada con un
        menú de opciones como el siguiente:
            ...
            5. Salir
* Se utilizará el campo de estado para indicar si el ítem del array está ocupado o no.
* El gráfico deberá ser un gráfico de barras en donde se agruparán tres barras:
